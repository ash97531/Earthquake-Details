...
//            "{\"type\":\"Feature\",\"properties\":{\"mag\":6,\"place\":\"Pacific-Antarctic Ridge\",\"time\":1451986454620,\"updated\":1459202978040,\"tz\":-540,\"url\":\"http://earthquake.usgs.gov/earthquakes/eventpage/us10004bgk\",\"detail\":\"http://earthquake.usgs.gov/fdsnws/event/1/query?eventid=us10004bgk&format=geojson\",\"felt\":0,\"cdi\":1,\"mmi\":0,\"alert\":\"green\",\"status\":\"reviewed\",\"tsunami\":0,\"sig\":554,\"net\":\"us\",\"code\":\"10004bgk\",\"ids\":\",us10004bgk,gcmt20160105093415,\",\"sources\":\",us,gcmt,\",\"types\":\",cap,dyfi,geoserve,losspager,moment-tensor,nearby-cities,origin,phase-data,shakemap,\",\"nst\":null,\"dmin\":30.75,\"rms\":0.67,\"gap\":71,\"magType\":\"mww\",\"type\":\"earthquake\",\"title\":\"M 6.0 - Pacific-Antarctic Ridge\"},\"geometry\":{\"type\":\"Point\",\"coordinates\":[-136.2603,-54.2906,10]},\"id\":\"us10004bgk\"}],\"bbox\":[-153.4051,-54.2906,10,158.5463,59.6363,582.56]}";
     ...
     */
    private static ArrayList <details> extractFeatureFromJson(String earthquakeJSON) {
        Log.v("main", "ExtractJsonFeature\n");
        ...
        try {
            ...
            // represent unix time format, i.e milliseconds over from 1 jan 1970
//            long timeinmillisec;
//            Date dateobject;
//
...
//            String datetodisplay;
            ...
            // creating objectfeature from json root object
            JSONArray jsonarray = jsonrootobject.optJSONArray("features");

            // iterate in json array
            for (int i=0; i<jsonarray.length(); i++){
                JSONObject arrayobject = jsonarray.getJSONObject(i);

                JSONObject objectproperties = arrayobject.getJSONObject("properties");

                double magnitude = objectproperties.getDouble("mag");
                String place = objectproperties.optString("place").toString();
                long timeinmillisec = objectproperties.getLong("time");
...
//                datetodisplay = dateformatter.format(dateobject);
                ...
                earthquakes.add(new details(magnitude, place, timeinmillisec, url));
            }
    ...
    /**
     * Query the USGS dataset and return a list of {@link details} objects.
     */
    public static List<details> fetchEarthquakeData(String requestUrl) {

        // making the thread sleep for 2sec to check whether loading spinner is working or not
        /*
        try {
            Thread.sleep(2000);
        ...
        List<details> earthquakes = extractFeatureFromJson(jsonResponse);
